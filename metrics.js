...
Metrics.prototype.summary = function summary() {
  ...
  var count = this.connections + this.failures + this.disconnects;
  // fs.appendFile('log.txt', count.toString() + ' ' + this.failures.toString() + ' ' + 
  // (this.failures / count).toString() + ' ' + handshaking.amean().toFixed().toString() + 
  // ' ' + latency.amean().toFixed().toString() + '\n', function (err) {
  //   if (err) {
  //     console.log('err');
  //     throw err;
  //   }
  ...
  fs.appendFileSync('log.txt', count.toString() + ' ' + this.failures.toString() + ' ' + 
  (this.failures / count).toString() + ' ' + handshaking.amean().toFixed().toString() + 
  ' ' + latency.amean().toFixed().toString() + '\n')
